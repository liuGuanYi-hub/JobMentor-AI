...
- 专业排名前 5%，GPA 3.8/4.0
- 主修课程：数据结构与算法、操作系统、计算机网络、数据库系统、移动应用开发
- 获国家励志奖学金（2024、2025）、校级 ACM 程序设计竞赛二等奖
- 担任班级学习委员，组织期末复习串讲 6 次，覆盖全班 40+ 人
...
时间：2026.04 - 2026.07
- 参与数据聚合服务与数据处理管道开发维护，负责订单流水与用户行为数据的清洗与聚合
- 用 Java 重构 ETL 流程，将日处理量从 50 万条提升至 200 万条，数据吞吐提升 30%，任务失败率下降 25%
- 通过索引优化与批次写入降低数据库压力，查询 P95 延迟从 800ms 降至 300ms
- 撰写数据接口文档并参与 Code Review，沉淀团队统一异常处理规范
...
【技能清单】
- 移动端: Kotlin, Jetpack Compose, MVVM, Repository, Room, Retrofit, Coroutines
- 后端: Java, Spring Boot, MySQL, Redis, RabbitMQ
- 工具: Git, Linux, Docker, Postman, JUnit

【自我评价】
对移动端工程充满热情，具备从需求拆解、接口联调到问题定位的完整闭环能力；注重代码质量与可维护性，习惯用数据量化交付结果。`;
